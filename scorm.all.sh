...
./scorm.sh gift.scorm.zip 'SCORM GIFT Demo SCO' scorm.gift.html gift.encoded.txt gift.md gift.css gift.js gift.question.js scorm.gift.js array.shuffle.js jqueryui.matching.* utils.scorm.js;
rm gift.encoded.txt;
